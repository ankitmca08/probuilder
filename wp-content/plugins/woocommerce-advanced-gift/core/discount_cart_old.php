...
//                }
          ...
          <td class="product-total" style="color: #ea1b25;">Free Gift!</td>
        ...
        if (isset($rule['pw_cart_amount'])) {
            ...
            switch ($rule['cart_amount_op']) {
                ...
                case '>':
                    ...
                    if (!empty($rule['pw_cart_amount']) && $this->cart['amount'] < $rule['pw_cart_amount']) {
...
//                }
               ...
               /*    echo '
                  ...
                  <td class="product-quantity"><span class="fqnant">1</span></td>

                  <td class="product-subtotal">NZ $0.00</td>
                ...
                echo '
							...
							<tr class="woocommerce-cart-form__cart-item cart_item">
								...
								<td class="product-price" data-title="Price"><span class="fpric">Free Gift!</span></td>
								<td class="product-quantity" data-title="Quantity"><span class="fqnant">1</span></td>
								<td class="product-subtotal" data-title="Total">NZ $0.00</td>								 
							</tr>';
