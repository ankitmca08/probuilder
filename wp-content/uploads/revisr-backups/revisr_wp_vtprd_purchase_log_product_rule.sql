...
DROP TABLE IF EXISTS `wp_vtprd_purchase_log_product_rule`;
...
LOCK TABLES `wp_vtprd_purchase_log_product_rule` WRITE;
/*!40000 ALTER TABLE `wp_vtprd_purchase_log_product_rule` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_vtprd_purchase_log_product_rule` ENABLE KEYS */;
UNLOCK TABLES;
