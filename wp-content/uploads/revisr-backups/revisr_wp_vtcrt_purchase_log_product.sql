...
DROP TABLE IF EXISTS `wp_vtcrt_purchase_log_product`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wp_vtcrt_purchase_log_product` (
...
LOCK TABLES `wp_vtcrt_purchase_log_product` WRITE;
/*!40000 ALTER TABLE `wp_vtcrt_purchase_log_product` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_vtcrt_purchase_log_product` ENABLE KEYS */;
UNLOCK TABLES;
