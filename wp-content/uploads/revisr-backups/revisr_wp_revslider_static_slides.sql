...
INSERT INTO `wp_revslider_static_slides` VALUES (1,1,'{\"bg\":{\"image\":\"http:\\/\\/shlokinfotech.com\\/probuilder\\/wp-content\\/\"},\"thumb\":{\"customThumbSrc\":\"http:\\/\\/shlokinfotech.com\\/probuilder\\/wp-content\\/\"}}','[]','{\"version\":\"6.0.0\"}'),(2,5,'[]','','{\"temp\":true}');
