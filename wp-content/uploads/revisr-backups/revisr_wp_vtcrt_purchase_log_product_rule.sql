...
DROP TABLE IF EXISTS `wp_vtcrt_purchase_log_product_rule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wp_vtcrt_purchase_log_product_rule` (
...
LOCK TABLES `wp_vtcrt_purchase_log_product_rule` WRITE;
/*!40000 ALTER TABLE `wp_vtcrt_purchase_log_product_rule` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_vtcrt_purchase_log_product_rule` ENABLE KEYS */;
UNLOCK TABLES;
