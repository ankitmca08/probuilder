...
DROP TABLE IF EXISTS `wp_vtprd_purchase_log`;
...
CREATE TABLE `wp_vtprd_purchase_log` (
  ...
  `ruleset_object` longtext COLLATE utf8mb4_unicode_ci,
  `cart_object` longtext COLLATE utf8mb4_unicode_ci,
  KEY `id` (`id`,`cart_parent_purchase_log_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

LOCK TABLES `wp_vtprd_purchase_log` WRITE;
/*!40000 ALTER TABLE `wp_vtprd_purchase_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_vtprd_purchase_log` ENABLE KEYS */;
UNLOCK TABLES;
